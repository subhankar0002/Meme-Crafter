...
export default function Navbar({ darkMode, setDarkMode }) {
    ...
    return (
        <header className={`shadow sticky top-0 z-50 ${darkMode ? "bg-gray-800 text-white" : "bg-slate-100 text-black"}`}>
                ...
                <AnimatePresence>
                    {isMenuOpen && (
                        <motion.div
                            ...
                            className={`absolute top-full left-0 w-full ${darkMode ? "bg-gray-900 text-white" : "bg-slate-300 text-black"} shadow-lg lg:hidden`}
                        >
